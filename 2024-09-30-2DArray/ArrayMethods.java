...
public class ArrayMethods {
  ...
  */
  ...
  public static void main (String[] args) {
    ...
    System.out.println("Expected: [[1, 4], [2, 5], [3, 6]] | Return: " + arrToString(swapRC(ary1c)) + " | Match? " + arrToString(swapRC(ary1c)).equals("[[1, 4], [2, 5], [3, 6]]"));
    int[][] ary2c = {{4, 7, 15}, {13, 28, 6}, {14, 28, 37}};
    System.out.println("Expected: [[4, 13, 14], [7, 28, 28], [15, 6, 37]] | Return: " + arrToString(swapRC(ary2c)) + " | Match? " + arrToString(swapRC(ary2c)).equals("[[4, 13, 14], [7, 28, 28], [15, 6, 37]]"));
    int[][] ary3c = {{1, 2}, {4, 5}, {7, 8}};
    System.out.println("Expected: [[1, 4, 7], [2, 5, 8]] | Return: " + arrToString(swapRC(ary3c)) + " | Match? " + arrToString(swapRC(ary3c)).equals("[[1, 4, 7], [2, 5, 8]]"));
    int[][] ary4c = {{1}, {4}, {7}};
    System.out.println("Expected: [[1, 4, 7]] | Return: " + arrToString(swapRC(ary4c)) + " | Match? " + arrToString(swapRC(ary4c)).equals("[[1, 4, 7]]"));
    int[][] ary5c = {{0, 0, 0}, {0, 0, 0}, {0, 0, 0}};
    System.out.println("Expected: [[0, 0, 0], [0, 0, 0], [0, 0, 0]] | Return: " + arrToString(swapRC(ary5c)) + " | Match? " + arrToString(swapRC(ary5c)).equals("[[0, 0, 0], [0, 0, 0], [0, 0, 0]]"));
    int[][] ary6c = {{0}, {0}, {0}};
    System.out.println("Expected: [[0, 0, 0]] | Return: " + arrToString(swapRC(ary6c)) + " | Match? " + arrToString(swapRC(ary6c)).equals("[[0, 0, 0]]"));
  }
